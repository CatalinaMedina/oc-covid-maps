  ...
  plot_data <- covid_data_by_zip %>% 
    ...
    mutate(plot_var = factor(
      case_when(
        ...
        new_cases_scaled <= 25 ~ "6-25",
        new_cases_scaled <= 50 ~ "26-50",
        new_cases_scaled <= 100 ~ "51-100",
        new_cases_scaled <= 250 ~ "101-250",
        new_cases_scaled <= 500 ~ "251-500",
  ...
  plot_data <- covid_data_by_zip %>% 
    ...
    mutate(plot_var = factor(
      case_when(
        ...
        new_tests_scaled <= 250 ~ "101-250",
        new_tests_scaled <= 500 ~ "251-500",
        new_tests_scaled <= 1000 ~ "501-1000",
        new_tests_scaled <= 2500 ~ "1001-2500",
